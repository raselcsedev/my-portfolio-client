...
const AboutMe = () => {
  return (
    <div id="about" className=" lg:pt-16 pb-20 text-[#112B3C] font-ralway">
      <div className=" ">
        <div className="mb-16 ">
          ...
          <div className="flex-1  pt-20 md:pt-0 font-semibold">
            ...
            <div className="mt-4">
              ...
              <p className="text-white ">
                {" "}
                HTML5 , CSS3 , Bootstrap ,Tailwind, JavaScript, React JS, React
                Router, Firebase , JWT, Express JS, MonogDB,And many React
                libraries
              </p>
            </div>
          </div>
